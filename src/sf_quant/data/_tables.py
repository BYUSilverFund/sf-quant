...
# New tables
signals_table = Table("signals", os.getenv("SIGNALS_TABLE"))
scores_table = Table("scores", os.getenv("SCORES_TABLE"))
alphas_table = Table("alphas", os.getenv("ALPHAS_TABLE"))
combined_alphas_table = Table("combined_alphas", os.getenv("COMBINED_ALPHAS_TABLE"))
weights_table = Table("weights", os.getenv("WEIGHTS_TABLE"))
